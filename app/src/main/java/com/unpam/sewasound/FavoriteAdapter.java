...
public class FavoriteAdapter  extends RecyclerView.Adapter<FavoriteViewHolder>{
    ...
    AlertDialog alert;
    public FavoriteAdapter(Context context, @NonNull ArrayList<SoundBarangItem> dataList) {
        mdataList = dataList;
    ...
    @UiThread
    @Override
    public void onBindViewHolder(FavoriteViewHolder parentHolder, final int position) {
        ...
        parentHolder.favoriteButton.setClickable(false);
